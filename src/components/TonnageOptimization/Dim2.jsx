...
const Dim2 = ({ sessionId }) => {
  ...
  const getData = () => {
    const gridElement = document.querySelector("#Dim2_Sheet");
    if (!gridElement) {
      return;
    }

    const tdElements = document.querySelectorAll("#Dim2_Sheet .e-cell");
  ...
  const handleSave = () => {
    getData();
    alert("Dim2 data saved successfully");
  };
